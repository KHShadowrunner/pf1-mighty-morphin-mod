...
/**
 * Application for selecting a shape from the Fey Form spell to change into and then applying that shape to an actor
 */
export class MorphinFeyForm extends MorphinPolymorphDialog {
    /**
     * @inheritdoc
    ...
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            ...
            popOut: true,
            template: 'modules/pf1-mighty-morphin/templates/feyFormDialog.html',
            id: 'mighty-morphin-feyForm',
